    ...
    render() {
        ...
        return (
            <div className="modal">
                ...
                <input type="radio" id="registration__executor" className="registration__type-user" name="executor"
                       value="executor"/>
                <label for="registration__executor" className="registration__type-user-lable">Исполнитель</label>

                <input type="radio" id="registration__performer" className="registration__type-user" name="executor"
                       value="executor"/>
